...
print "perfect", len(products[products['perfect']>=1])
products['contains_perfect']=(products['perfect']>=1)
print np.sum(products['contains_perfect'])
...
# word_coefficient_tuples = [(word, coefficient) for word, coefficient in zip
#   (important_words, coefficients)]
